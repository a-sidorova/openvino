...
//namespace op {
//
//// todo: update descriptions for all ops in the file
///**
// * @interface LoopBase
// * @brief Base class for LoopBegin and LoopEnd
// * @ingroup snippets
// */
//class LoopBaseLowered : public ngraph::op::Op {
//public:
//    OPENVINO_OP("LoopBaseLowered", "SnippetsOpset");
//    LoopBaseLowered() = default;
//};
//class LoopEnd;
///**
// * @interface LoopBegin
...
// * @ingroup snippets
// */
//class LoopBeginLowered : public LoopBaseLowered {
//
//public:
//    OPENVINO_OP("LoopBeginLowered", "SnippetsOpset", LoopBaseLowered);
//    LoopBeginLowered() = default;
...
// * @ingroup snippets
// */
//class LoopEndLowered : public LoopBaseLowered {
//public:
//    OPENVINO_OP("LoopEndLowered", "SnippetsOpset", LoopBaseLowered);
//    LoopEndLowered
//    LoopEndLowered(const std::shared_ptr<LoopBeginLowered>& begin, size_t work_amount, size_t work_amount_increment,
