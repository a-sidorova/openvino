 ...
 * @param m_allocation_size - memory size for allocation. Not in bytes!
...
public:
    ...
    Buffer() = default;
    Buffer(const OutputVector& arguments, size_t allocation_size = 0, size_t id = 0, ov::element::Type element_type = ov::element::u8);
...
public:
    ...
    IntermediateMemoryBuffer(const ov::Output<ov::Node>& arg, size_t allocation_size = 0, size_t id = 0);
