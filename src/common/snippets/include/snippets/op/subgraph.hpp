...
private:
    ...
    // This LinearIR is converted from body_ptr() (ov::Model) after DataFlow transformations and
    // used for ControlFlow transformations and ShapeInfer.
    std::shared_ptr<lowered::LinearIR> m_linear_ir = nullptr;
    // This LinearIR is used for Generation transformations and code emission.
    std::shared_ptr<lowered::LinearIR> m_generation_linear_ir = nullptr;
