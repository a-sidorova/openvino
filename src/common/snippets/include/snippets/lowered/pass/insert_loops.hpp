...
private:
    ...
    static std::pair<std::shared_ptr<op::LoopBegin>, std::shared_ptr<op::LoopEnd>> make_loop(
                                                      bool is_dynamic, size_t work_amount, size_t work_amount_increment,
    ...
    static bool is_dynamic(const LinearIR::LoopManager::LoopInfoPtr& loop_info);
};
