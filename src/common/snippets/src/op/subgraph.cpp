...
snippets::Schedule snippets::op::Subgraph::generate(
    ...
    ov::pass::Serialize("before_" + get_friendly_name() +".xml",
                        "before_" + get_friendly_name() +".bin").run_on_model(body_ptr());
    ...
    ov::pass::Serialize("after_" + get_friendly_name() +".xml",
                        "after_" + get_friendly_name() +".bin").run_on_model(body_ptr());
