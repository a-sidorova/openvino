...
static brgemm_utils::BrgemmConfig brgemm_config_only_repacking(const ov::element::Type& src_dt) {
    return brgemm_utils::BrgemmConfig(src_dt, dnnl::impl::cpu::x64::cpu_isa_t::avx512_core, true, false, false);
}
static brgemm_utils::BrgemmConfig brgemm_config_with_comps() {
    return brgemm_utils::BrgemmConfig(ov::element::i8, dnnl::impl::cpu::x64::cpu_isa_t::avx512_core_vnni, true, true, false);
}
static brgemm_utils::BrgemmConfig brgemm_config_amx(const ov::element::Type& src_dt) {
    return brgemm_utils::BrgemmConfig(src_dt, dnnl::impl::cpu::x64::cpu_isa_t::avx512_core_amx, true, false, true);
}
} // namespace
