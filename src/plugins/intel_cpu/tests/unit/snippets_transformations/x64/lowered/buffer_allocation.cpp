...
protected:
    std::shared_ptr<ov::Model> GetModel() const override {
        ...
        const auto brgemm_config = intel_cpu::brgemm_utils::BrgemmConfig(ov::element::bf16, dnnl::impl::cpu::x64::cpu_isa_t::avx512_core_amx,
                                                                         true, false, true);
        ...
        const auto brgemm_cpu0 = std::make_shared<ov::intel_cpu::BrgemmCPU>(parameter0, brgemm_copyb0->output(0), scratch0, brgemm_config);
        ...
        const auto brgemm_cpu1 = std::make_shared<ov::intel_cpu::BrgemmCPU>(convert2, brgemm_copyb1->output(0), scratch1, brgemm_config);
