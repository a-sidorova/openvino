...
std::vector<std::vector<InputShape>> transposedShape_4D(bool with_dynamic = true) {
    ...
    if (with_dynamic) {
        ...
        {
            {PartialShape{-1, -1, -1, -1}, {{1, 128, 3, 64},  {2, 16, 2, 197},  {1, 128, 3, 64}}},
            {PartialShape{-1, -1, -1, -1}, {{1, 128, 1, 64},  {2, 128, 2, 197}, {1, 128, 1, 64}}},
            {PartialShape{-1, -1, -1, -1}, {{2, 1, 128, 128}, {2, 2, 16, 128},  {2, 1, 128, 128}}},
            {PartialShape{-1, -1, -1, -1}, {{1, 128, 3, 64},  {2, 128, 2, 197}, {1, 128, 3, 64}}},
        },
        {
