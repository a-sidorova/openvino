...
#define NGRAPH_OP(NAME, NAMESPACE) opset.insert<NAMESPACE::NAME>();
        ...
        NGRAPH_OP(KernelStatic, ov::snippets::op)
        NGRAPH_OP(KernelDynamic, ov::snippets::op)
        NGRAPH_OP(IntermediateMemoryBuffer, ov::snippets::op)
        NGRAPH_OP(Load, ov::snippets::op)
        NGRAPH_OP(LoadReshape, ov::snippets::op)
        NGRAPH_OP(LoopBeginStatic, ov::snippets::op)
        NGRAPH_OP(LoopBeginDynamic, ov::snippets::op)
        NGRAPH_OP(LoopEndStatic, ov::snippets::op)
        NGRAPH_OP(LoopEndDynamic, ov::snippets::op)
