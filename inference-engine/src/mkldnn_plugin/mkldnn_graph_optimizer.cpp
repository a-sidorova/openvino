...
void MKLDNNGraphOptimizer::FuseMultiplyAndAdd(MKLDNNGraph &graph) {
    ...
    auto isSuitableSecondInput = [](MKLDNNNodePtr node, SizeVector dataDims) {
    ...
    auto isSuitableParentNode = [&](MKLDNNNodePtr node) {
        ...
        return isSuitableSecondInput(node->getParentEdgesAtPort(1)[0]->getParent(), node->getParentEdgesAtPort(0)[0]->getShape().getDims());
    };
    ...
    auto isSuitableChildNode = [&](MKLDNNNodePtr parentNode, MKLDNNNodePtr childNode) {
        ...
        return isSuitableSecondInput(childNode->getParentEdgesAtPort(1)[0]->getParent(), childNode->getParentEdgesAtPort(0)[0]->getShape().getDims()) &&
